                ...
                <div class="card-body">
                    <form id="updateProjectForm" method="post" action="{{ route('projects.update', $project->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$project->name}}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea rows="3" cols="50" id="description" type="description" class="form-control" name="description" >{{$project->description}}
                                </textarea>
                            </div>
                        </div>
